...
from Dict import seq_to_id
from utility.constants import core_nlp_url
import networkx as nx

from src import *
from modules.helper_module import myunpack
from torch.nn.utils.rnn import pad_packed_sequence as unpack
from torch.nn.utils.rnn import PackedSequence
from DataIterator import DataIterator,rel_to_batch
...
class AMRDecoder(object):
    ...
    def probToId(self, srcBatch,probBatch,sourceBatch):
        ...
        srcBatch = unpack(srcBatch,batch_first=False, padding_value=0)[0]
